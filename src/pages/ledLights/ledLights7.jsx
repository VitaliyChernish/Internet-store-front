...
const LedLights7 = ({ linkOfOffer }) => {
    ...
    const stepsArr = [
        ...
        { step: 'Крок 3:', text: `Ви отримуєте замовлення протягом 2-3 робочих днів.`, icon: successfulDelivery },
        { step: 'Крок 4:', text: `Насолоджуєтесь атмосферою свята`, icon: relax },
    ]
    const priorityArr = [
            ...
            <div style={{ width: window.innerWidth <= 599 ? window.innerWidth : 600 }}
                ...
                <div className={s.priceContentMain}>
                    ...
                    <div className={s.offerButton1}>
                        <ButtonOffer buttonPlace='2' buttontext={'Хочу замовити'} />
                    </div>
                </div>
            </div>
        </div>
